...
import logoSvg from "../assets/img/the_heros_story_icon.svg";
	...
	return (
		<nav className="navbar navbar-expand-lg navbar-light bg-white border-bottom py-3">
			<div className="container-fluid px-md-5">
				...
				<Link 
					to="/" 
					className="navbar-brand fw-black fs-2 text-dark m-0 d-inline-flex align-items-center gap-4" 
					style={{ letterSpacing: "-1.5px", fontFamily: "'Inter', sans-serif" }}
				>
					<img 
						src={logoSvg} 
						alt="The Hero's Story Logo" 
